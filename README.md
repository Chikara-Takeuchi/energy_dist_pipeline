...
* **`annotation_file`**: (String) Filename for the processed gRNA annotation table. This file is generated by `0_preprocess.py` to link gRNAs to target transcripts/genes and sources (target, neg\_control, etc.).
