...
0. Build Container from Dockerhub
    ```bash
    cd ./container
    apptainer pull edist_pipeline.sif docker://docker.io/takechikara/energy_distance_env:latest
    ```
    edist_pipeline.sif will be created in the folder.
